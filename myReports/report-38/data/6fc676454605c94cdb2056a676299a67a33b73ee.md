...
```yaml
- link:
  - /url: /dashboard.xhtml;jsessionid=node01afh1aov984xm17k8z7bbaambg1123681.node0
- link "":
  - /url: "#"
- link:
  - /url: "#"
...
> 70 |         console.log(await clicEle.innerText())
  ...
  78 |
  79 |     const innerFrameEle= page.frameLocator("//h5[text()=' Click Me (Inside Nested frame)']//following::iframe")
